...
@section('content')
    ...
    <div class='container-fluid'>
                ...
                <div class='title'>
                    ...
                    <img class='reparacion' src='../css/img/avanzadoV.png' width='85' height='100'>

                    <h4 class='service'> Plan de VPS avanzado. </h4>
                    ...
                    <div class='col-md-4'>
                        <form method='post' action='{{ Route('hosting.store') }}'>
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" value='{{ old('telefono') }}' name='correo' type="email" class="form-control @error('correo') is-invalid @enderror" placeholder="email@mail.com">
                            </div>
