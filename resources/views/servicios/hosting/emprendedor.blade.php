<link href='/css/hosting/emprendedor.css' rel='stylesheet'>
...
@section('content')
    ...
    <div class='container-fluid'>
                ...
                <div class='title'>
                    ...
                    <img class='reparacion' src='../css/img/EmprendedorH.png' width='85' height='100'>

                    <h4 class='service'> Plan de hosting para emprendedores. </h4>
