<link href='/css/hosting/base_de_datos.css' rel='stylesheet'>
...
@section('content')
    ...
    <div class='container-fluid'>
                ...
                <div class='title'>
                    ...
                    <img class='reparacion' src='../css/img/bdd.png' width='85' height='100'>

                    <h4 class='service'> Plan de Base de datos MySQL profesional. </h4>
                    ...
                    <div class='col-md-4'>
                        <form method='post' action='{{ Route('hosting.store') }}'>
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" value='{{ old("telefono") }}' name='telefono' {{-- type="number" --}} class="form-control @error('telefono') is-invalid @enderror" id="telefono" placeholder="0414-1234567">
                            </div>
                            <!-- Whatsapp -->
